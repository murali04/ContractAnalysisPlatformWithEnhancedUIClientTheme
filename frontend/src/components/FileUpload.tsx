      ...
      <div className='flex flex-col justify-center relative overflow-hidden'>
        <div className='relative'>
          ...
          <p className='text-lg mb-2'>
            Automated compliance verification powered by advanced RAG technology.
            <br />
              ...
              {excelFile ? (
                <div className='flex gap-6'>
                  ...
                  <div className='text-center flex-1'>
                    <p className='text-green-900 truncate max-w-[200px]'>{excelFile.name}</p>
            ...
            >
              {pdfFile ? (
                <div className='flex gap-6'>
                  ...
                  <div className='text-center flex-1'>
                    <p className='text-green-900 truncate max-w-[200px]'>{pdfFile.name}</p>
                    <p className='text-xs text-green-600 mt-1'>
